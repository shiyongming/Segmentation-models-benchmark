...
def allocate_buffers(context):
    ...
    for binding in engine:
        #size = trt.volume(engine.get_binding_shape(binding)) * engine.max_batch_size   # For fixed shapes
        size = trt.volume(context.get_binding_shape(0)) * engine.max_batch_size   # For dynamic shapes
